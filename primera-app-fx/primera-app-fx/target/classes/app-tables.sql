...
CREATE TABLE usuario (
    ...
    usuarioname TEXT UNIQUE NOT NULL;
...
INSERT INTO usuario (usuarioname, nombre, contrasenia, email) VALUES
    ('Joan','Juan Pérez', 'pass123', 'juan@example.com'),
    ('Anna','Ana López', 'securePass', 'ana@example.com'),
    ('Charles','Carlos Gómez', 'claveSegura', 'carlos@example.com');
